package com.trymeon.app.data.tryon
...
import com.trymeon.app.domain.tryon.VirtualModel
import com.trymeon.app.domain.tryon.VirtualModelSignature
...
class VirtualModelStore(
    ...
    private val fashn: com.trymeon.app.data.remote.ReplicateApiService? = null,
